...
*/
	...
	int *d_seq_matches;
    CUDA_CHECK_FUNCTION( cudaHostRegister( seq_matches, sizeof(int) * seq_length, cudaHostRegisterDefault ) );
    ...
    CUDA_CHECK_FUNCTION( cudaHostUnregister( seq_matches ) );
    ...
    CUDA_CHECK_FUNCTION( cudaHostRegister( pat_found, sizeof(unsigned long) * pat_number, cudaHostRegisterDefault ) );
    ...
    CUDA_CHECK_FUNCTION( cudaHostUnregister( pat_found ) );
